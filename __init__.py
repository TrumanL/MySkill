...
class MySkill(MycroftSkill):
  ...
  def initialize(self):
      ...
      try:
          ...
          GPIO.setup(self.GPIO_Port, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
          self.log.info("******GPIO SETUP")
          GPIO.add_event_detect(self.GPIO_Port, GPIO.RISING, callback=self.handle_read_messages_passive, bouncetime=300)
